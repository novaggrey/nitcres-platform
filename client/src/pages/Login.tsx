        ...
        <section className="flex items-center justify-center px-6 py-10 sm:px-10 lg:px-16">
          <div className="w-full max-w-md">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5 shadow-2xl shadow-black/20">
              ...
              <label className="mt-4 block text-xs text-slate-500">Demo password<input value={password} onChange={(e) => setPassword(e.target.value)} type="text" className="mt-2 h-11 w-full rounded-xl border border-white/10 bg-[#081725] px-3 text-sm text-white outline-none transition focus:border-cyan-300/50" autoComplete="current-password" /></label>
              ...
              <p className="mt-3 text-center text-[11px] leading-5 text-slate-600">Demo access previews synthetic records only. It does not create an authenticated institutional session or authorize protected actions.</p>
            </div>
